...
function ConversationLink({
  ...
  return (
    <div className="issue-conversation-actions">
      ...
      >
        {agentPlatform ? <img src={copyIdIcon} width={16} height={16} alt="" /> : <CodexResumeIcon />}
                ...
                {editingDescription ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      type="button"
                      disabled={isFeishuTask || savingProperty === "description"}
            ...
            {executionTargetEnabled && (
              <div className="detail-property-row">
                ...
                <TaskPropertyPicker
                  ...
                  disabled={savingProperty === "executionTarget" || executionTargetOptions.length === 0 || (currentTask.status === "in_progress" && currentTask.threadBinding !== null)}
